...
# results/nimble/unimodal_moi_10_4_1000_10_0.10_3_20000_10000_1_0.3_1000000_equalmixture_200.00_4_summary.rds
args = c('10',
  '4',
  '1000',
  '10',
...
moi = as.numeric(args[10])
n_cells = as.integer(args[11])
effect_size_type = as.character(args[12])
dispersion = as.numeric(args[13])
n_mcmc_chains = as.integer(args[14])
